 ...
 */
@TargetApi(21)
public class NotificationBuilderAPI21 implements NotificationBuilder {

    private Notification.Builder builder;

    public NotificationBuilderAPI21(Context context) {
    ...
    public NotificationBuilder setMediaStyleActionsInCompactView(int... actions) {
        builder.setStyle(new Notification.MediaStyle(builder).setShowActionsInCompactView(actions));
        return this;
    }
